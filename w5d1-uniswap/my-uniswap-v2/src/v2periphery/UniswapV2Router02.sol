...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    error UniswapV2Router_InsufficientOutputAmount(uint256, uint256);
        ...
        returns (uint[] memory amounts)
    {
        ...
        if (amounts[amounts.length - 1] < amountOutMin) {
            revert UniswapV2Router_InsufficientOutputAmount(
    ...
    error UniswapV2Router_ExcessiveInputAmount(uint256, uint256);
    ...
    function swapTokensForExactETH(
        ...
        if (amounts[0] > amountInMax) {
            revert UniswapV2Router_ExcessiveInputAmount(
                amounts[0],
                amountInMax
            );
        }
